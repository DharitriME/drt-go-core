//go:generate protoc -I=. -I=$GOPATH/src -I=$GOPATH/src/github.com/DharitriME/protobuf/protobuf  --gogoslick_out=$GOPATH/src block.proto
package block
...
import (
	...
	"github.com/DharitriME/drt-go-core/data/headerVersionData"
)
