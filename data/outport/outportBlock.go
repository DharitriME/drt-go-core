//go:generate protoc -I=. -I=$GOPATH/src/github.com/DharitriME/drt-go-core/data/block -I=$GOPATH/src -I=$GOPATH/src/github.com/DharitriME/protobuf/protobuf --gogoslick_out=$GOPATH/src outportBlock.proto
