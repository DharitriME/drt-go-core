//go:generate protoc -I=. -I=$GOPATH/src -I=$GOPATH/src/github.com/DharitriME/protobuf/protobuf  --gogoslick_out=. scheduled.proto
package scheduled

import (
	"github.com/DharitriME/drt-go-core/data"
	"github.com/DharitriME/drt-go-core/data/block"
	"github.com/DharitriME/drt-go-core/data/smartContractResult"
	"github.com/DharitriME/drt-go-core/data/transaction"
)
