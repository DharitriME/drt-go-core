...
protoc \
    -I="$HOME/go/src" \
    -I="$HOME/go/src/github.com/DharitriME/protobuf" \
    -I="$PWD/data/batch" \
...
mv $PWD/data/alteredAccount/github.com/DharitriME/drt-go-core/data/alteredAccount/alteredAccount.pb.go $PWD/data/alteredAccount/
...
mv $PWD/data/receipt/github.com/DharitriME/drt-go-core/data/receipt/receipt.pb.go $PWD/data/receipt/
...
mv $PWD/data/rewardTx/github.com/DharitriME/drt-go-core/data/rewardTx/rewardTx.pb.go $PWD/data/rewardTx/
...
mv $PWD/data/smartContractResult/github.com/DharitriME/drt-go-core/data/smartContractResult/smartContractResult.pb.go $PWD/data/smartContractResult/
...
mv $PWD/data/transaction/github.com/DharitriME/drt-go-core/data/transaction/*.pb.go $PWD/data/transaction/
...
mv $PWD/data/outport/github.com/DharitriME/drt-go-core/data/outport/*.pb.go $PWD/data/outport/
